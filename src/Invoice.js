...
const Invoice = ( { invoiceData, setInvoiceData, estimateData, descriptionList, projectList, setProjectList, customerList }) => {
  ...
  const saveInvoice = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://bgs-program-api.herokuapp.com/invoice', req);
      ...
      await fetch(`https://bgs-program-api.herokuapp.com/projects/${id}`, reqProj);
  ...
  const updateInvoice = async (id) => {
    try {
      ...
      await fetch(`https://bgs-program-api.herokuapp.com/invoice/${id}`, req);
